...
class BinaryTree {
    public void printAllElementsAtKDistanceFromLeafNode(BinaryTreeNode node, int k) {
        if (node == null || k < 0) {
            return;
        }
        int arr[] = new int[20];
    ...
    public void printAllElementsAtKDistanceFromLeafNodeUtil(BinaryTreeNode node, int k, int[] arr,
    ...
    public BinaryTreeNode createNewNode(int val) {
...
public class BinaryTreeApp {
    public static void main(String[] args) {
        ...
        BinaryTreeNode root = a.createNewNode(2);
